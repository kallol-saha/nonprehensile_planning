...
from pybullet_ompl import pb_ompl
...
class BoxDemo:
    def __init__(self):
        ...
        # load robot
        robot_id = p.loadURDF(
            "pybullet_planning/models/franka_description/robots/panda_arm_hand.urdf",
            (0, 0, 0),
            useFixedBase=1,
        )
    ...
    def add_box(self, box_pos, half_box_size):
        ...
        box_id = p.createMultiBody(
            baseMass=0, baseCollisionShapeIndex=colBoxId, basePosition=box_pos
        )
