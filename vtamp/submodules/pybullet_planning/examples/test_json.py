...
from pybullet_tools.parse_json import parse_body, parse_pose, parse_region, parse_robot
...
BODY_FIELDS = ["table_names", "sink_names", "stove_names"]
...
def parse_task(task, robots, bodies, regions):
    ...
    surfaces = (
        [bodies[n] for n in task["table_names"]]
        + list(regions.values())
        + sinks
        + stoves
    )
    ...
    goal_conf = None
    goal_on = [
        (bodies[n1], bodies[n2]) for n1, n2 in task["goal_stackings"].items()
    ...
    body_names = {
        body: name for name, body in list(bodies.items()) + list(regions.items())
    }
...
RSS = [
    ...
    "kitchen.json",
    "move_regrasp.json",
    "move_several_10.json",
    "move_several_12.json",
    "move_several_14.json",
    "move_several_16.json",
    "move_several_18.json",
    "move_several_20.json",
    "move_several_24.json",
    "move_several_28.json",
    "move_several_32.json",
    "move_several_4.json",
    "move_several_8.json",
    "nonmonotonic_4_1.json",
    "nonmonotonic_4_2.json",
    "push_table.json",
    "push_wall.json",
    "rearrangement_10.json",
    "rearrangement_12.json",
    "rearrangement_14.json",
    "rearrangement_16.json",
    "rearrangement_18.json",
    "rearrangement_20.json",
    "rearrangement_4.json",
    "rearrangement_6.json",
    "rearrangement_8.json",
    "replace.json",
    "separate_2.json",
    "separate_4.json",
    "separate_6.json",
    "separate_7.json",
    "shelf_arrangement.json",
    "simple.json",
    "simple2.json",
    "simple_holding.json",
    "simple_push.json",
    "srivastava_table.json",
    "stacking.json",
    "two_tables_1.json",
    "two_tables_2.json",
    "two_tables_3.json",
...
IJCAI = [
    "exists_hold_obs_0.json",
    "exists_hold_obs_1.json",
    "exists_hold_obs_2.json",
    "exists_hold_obs_4.json",
    "exists_hold_obs_5.json",
    "exists_holding_1.json",
    "exists_holding_2.json",
    "exists_holding_3.json",
    "exists_holding_blocked.json",
    "exists_holding_unreachable.json",
    "exists_region_1.json",
    "sink_stove_2_16.json",
    "sink_stove_2_20.json",
    "sink_stove_2_4.json",
    "sink_stove_2_8.json",
    "sink_stove_4_0.json",
    "sink_stove_4_12.json",
    "sink_stove_4_15.json",
    "sink_stove_4_16.json",
    "sink_stove_4_20.json",
    "sink_stove_4_30.json",
    "sink_stove_4_4.json",
    "sink_stove_4_40.json",
    "sink_stove_4_8.json",
]
...
def main(screenshot=False):
    ...
    for problem_filename in problem_filenames:
        ...
        if screenshot:
            ...
            os.system(
                "screencapture -R {},{},{},{} {}".format(225, 200, 600, 500, image_path)
            )
        else:
            wait_if_gui()
    disconnect()
