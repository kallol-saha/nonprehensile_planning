...
def parse_args():
    ...
    parser.add_argument(
        "--model",
        default="vn_dgcnn_partseg",
        help="Model name [default: vn_dgcnn_partseg]",
        choices=[
            "pointnet_partseg",
            "vn_pointnet_partseg",
            "dgcnn_partseg",
    ...
    parser.add_argument(
        "--epoch", default=250, type=int, help="Epoch to run [default: 250]"
    )
    parser.add_argument(
        "--learning_rate",
        default=0.001,
    ...
    parser.add_argument(
        "--optimizer", type=str, default="SGD", help="Adam or SGD [default: SGD]"
    )
    parser.add_argument(
        "--log_dir",
        type=str,
        default="vn_dgcnn/aligned",
