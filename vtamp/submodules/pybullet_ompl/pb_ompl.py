...
import vtamp.submodules.pybullet_ompl.utils as utils
import time
...
class PbOMPLRobot():
    ...
    def __init__(self, id) -> None:
        ...
        joint_idx = [j for j in all_joint_idx if self._is_revolute(j)]
    ...
    def _is_revolute(self, joint_idx):
        joint_info = p.getJointInfo(self.id, joint_idx)
        return joint_info[2] == p.JOINT_REVOLUTE
...
class PbOMPL():
    ...
    def plan(self, goal, start = None, allowed_time = DEFAULT_PLANNING_TIME):
        '''
