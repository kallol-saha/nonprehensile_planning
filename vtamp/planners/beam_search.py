...
class BeamSearch:
    def __init__(
        ...
        self.beam_width = cfg.planner.beam_width
    ...
    def plan(
        ...
        while (
            ...
            # For beam search, take best nodes from the open list
            ...
            for obj in self.obj_ids:
                ...
                for i, T in enumerate(proposed_transforms):
                    ...
                    if len(open_list.queue) > self.beam_width:
                        open_list.queue = sorted(open_list.queue)[: self.beam_width]
