...
from equivariant_pose_graph.dataset.point_cloud_data_module_obj_suggester import MultiviewDataModule
from equivariant_pose_graph.models.multimodal_transformer_flow import (
    Multimodal_ResidualFlow_DiffEmbTransformer,
    Multimodal_ResidualFlow_DiffEmbTransformer_WithPZCondX,
)
from equivariant_pose_graph.models.transformer_flow_obj_suggester import ResidualFlow_DiffEmbTransformer
from equivariant_pose_graph.training.flow_equivariance_training_module_nocentering_multimodal import (
...
def setup_main(cfg):
    ...
    trainer = pl.Trainer(
        ...
        if not cfg.pzX_adversarial
        else None,  # 0 is no clipping
    ...
    if cfg.decoder_type == "taxpose":  # This is satisfied in taxpose_vtamp config
        inner_network = ResidualFlow_DiffEmbTransformer(  # !!! This is the inner model
            ...
            conditioning_size=cfg.latent_z_linear_size
            if cfg.conditioning
            in [
    ...
    network = Multimodal_ResidualFlow_DiffEmbTransformer(  # !!! This is the main model
...
@hydra.main(config_path="assets/configs/training", config_name="taxpose_vtamp")
def main(cfg):
